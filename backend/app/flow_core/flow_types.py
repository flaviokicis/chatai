...
class ToolCall(BaseModel):
    ...
    messages: list[WhatsAppMessage] = Field(description="WhatsApp messages to send to user")
...
class GPT5Response(BaseModel):
    ...
    tools: list[ToolCallUnion] = Field(description="Tools to execute in sequence")
