...
# Tracing handled manually
    ...
    def _build_prompt(
        ...
        lines.extend([
            ...
            "- Suggest additional scenarios and edge cases the user might not have considered",
            "- Help create depth-first paths (complete one path fully before branching)",
            ...
            "- Be conversational and encouraging during the building process",
            "- Always ask 'what happens next?' to build complete flows",
            "",
            "## Example Flow Building Conversation:",
            "User: 'A primeira parte pode ser Ola! Somos a barbearia X'",
            "You: 'Perfeito! E quando o usuário responder a esse cumprimento, o que devo fazer em seguida?'",
            "User: 'Se responder quero marcar consulta, pergunta que horas'",
            "You: 'Ótimo! E depois que ele informar o horário?'",
            "User: 'Aí fala ok marcado'",
            "You: 'Excelente! E se o usuário não quiser marcar consulta? Que outras situações podem acontecer?'",
            "",
            "## CRITICAL: Flow Building Response Pattern:",
            "1. When user provides flow instructions, ALWAYS use tools to modify the flow",
            "2. After making changes, ask follow-up questions to continue building",
            "3. Be genuinely interested in creating the best possible flow",
            "4. Suggest improvements and additional scenarios",
            "",
        ])
