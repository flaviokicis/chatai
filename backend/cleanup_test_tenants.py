...
def cleanup_test_tenants():
    ...
    with db_session() as session:
        ...
        for tenant in tenants:
            ...
            if (
                (tenant.owner_first_name == "Test" and tenant.owner_last_name == "User")
                or (tenant.owner_first_name == "Schema" and tenant.owner_last_name == "Test")
                or (tenant.owner_first_name == "CLI" and tenant.owner_last_name == "Test")
            ):
